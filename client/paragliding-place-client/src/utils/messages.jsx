// This message is use in RegisterModal and show valid message for Username
export const ShowValidUsername = () => {
    return <p className="showIsValid">Username is valid!</p>
};

// This message is use in RegisterModal and show invalid message for Username
...
// This message is use in RegisterModal and ChangePassword and show password valid match message
export const PasswordValidMatch = () => {
    return <p className="showIsValid">Password match!</p>
};

// This message is use in RegisterModal and ChangePassword and show password mismatch message
